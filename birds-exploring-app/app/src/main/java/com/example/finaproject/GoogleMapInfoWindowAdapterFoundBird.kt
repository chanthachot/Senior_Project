...
import kotlinx.android.synthetic.main.info_window_foundbird.view.*


class GoogleMapInfoWindowAdapterFoundBird(var context: Context) : GoogleMap.InfoWindowAdapter {


    var mWindow = (context as Activity).layoutInflater.inflate(R.layout.info_window_foundbird, null)
    ...
    private fun rendowWindowText(marker: Marker, view: View) {
        ...
        amount.text = infoWindowData!!.amount
