...
import kotlinx.android.synthetic.main.scan.view.*


class scan_adapter(
    val item: List<BirdsDB>,
    val context: Context,
    var clickListener: ScanFragment
) : RecyclerView.Adapter<scan_adapter.MyViewHolder>(), Filterable {
    ...
    override fun onCreateViewHolder(
        ...
        val view_item =
            LayoutInflater.from(parent.context).inflate(R.layout.scan, parent, false)
    ...
    class MyViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        val tv_bird_family_name = view.tv_bird_family_name
