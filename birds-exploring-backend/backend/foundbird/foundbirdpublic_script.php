...
$('.editFoundBirdPublicModal').click(function() {
    ...
    function success(position) {
        ...
        var myLatlng = new google.maps.LatLng(data_edit_foundbirdpublic_lat, data_edit_foundbirdpublic_lng);
        ...
        google.maps.event.addListener(map, 'center_changed', function() {
            document.getElementById('input_edit_foundbirdpublic_lat').value = map.getCenter().lat();
            document.getElementById('input_edit_foundbirdpublic_lng').value = map.getCenter().lng();
        });
