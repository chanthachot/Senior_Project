...
$('.editFoundBirdPrivateModal').click(function() {
    ...
    function success(position) {
        ...
        var myLatlng = new google.maps.LatLng(data_edit_foundbirdprivate_lat, data_edit_foundbirdprivate_lng);
        ...
        google.maps.event.addListener(map, 'center_changed', function() {
            document.getElementById('input_edit_foundbirdprivate_lat').value = map.getCenter().lat();
            document.getElementById('input_edit_foundbirdprivate_lng').value = map.getCenter().lng();
        });
